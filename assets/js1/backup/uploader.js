        ...
        if (this.readyState == 4){
            if (this.status == 200){
                ...
                if (json.status_code == 200){
                    window.parent.SettingsProfile.Avatar.done(true, json.user);
                    Uploader.RefreshImage();
                } else {
                    window.parent.SettingsProfile.Avatar.done(false, null);
                }
            } else {
                window.parent.SettingsProfile.Avatar.done(false, null);
            }
...
if (uploaded == true){
    window.parent.SettingsProfile.Avatar.done(true, loggedInUser.username);
}