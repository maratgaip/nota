...
function totranslit($var, $lower = true, $punkt = true) {
	$NpjLettersFrom = "àáâ?äåçèêë?íîï?ñ?óôöû³";
	$NpjLettersTo = "abvgdeziklmnoprstufcyi";
	$NpjBiLetters = array ("é" => "j", "¸" => "yo", "æ" => "zh", "?" => "x", "÷" => "ch", "ø" => "sh", "ù" => "shh", "?" => "ye", "?" => "yu", "ÿ" => "ya", "ú" => "", "ü" => "", "¿" => "yi", "º" => "ye" );
	
	$NpjCaps = "ÀÁÂ?ÄÅ¨ÆÇÈÉÊË?ÍÎÏ?Ñ?ÓÔ?Ö×ØÙÜÚÛ??ß¯ª²";
	$NpjSmall = "àáâ?äå¸æçèéêë?íîï?ñ?óô?ö÷øùüúû??ÿ¿º³";
