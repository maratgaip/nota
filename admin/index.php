...
<head>
<meta charset="utf-8">
<title>Nota - Admin Control Panel</title>
...
<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container" style="width: auto;"> <a class="brand" href="{$PHP_SELF}?">Admin Control Panel</a>
			<ul class="nav">
              <li><a href="{$PHP_SELF}?do=config"><i class="icon-check icon-white"></i> Site config</a></li>
			...
			<ul class="nav pull-right">
				<li id="fat-menu" class="dropdown"> <a href="#" id="user-menu" role="button" class="dropdown-toggle" data-toggle="dropdown">{$member_id['username']} <b class="caret"></b></a>
					<ul class="dropdown-menu" role="menu" aria-labelledby="user-menu">
						<li><a tabindex="-1" href="{$PHP_SELF}?do=users">Manager members</a></li>
						<li><a tabindex="-1" href="{$PHP_SELF}?do=config">Site config</a></li>
						<li class="divider"></li>
...
HTML;
    ...
    <div id="footer">
      <div class="container">
        <p class="muted credit">Copyright &copy; 2014 by <a href="http://localhost" target="_blank">Nota</a></p>
      </div>
    </div>
    </div>
...
if( $user_group[$member_id['user_group']]['allow_m_radioprofile'] ) {
	$menu_bar[] = array(
				"icon" => "icon-radio",
				"text" => "Manager radioprofile",
				"link" => "radioprofile"
				);
}
if( $user_group[$member_id['user_group']]['allow_m_playlist'] ) {
	$menu_bar[] = array(
				"icon" => "icon-list",
				"text" => "Manager Playlist",
				"link" => "playlist"
				);
}
if( $member_id['user_group'] == 1 ) {
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Sign in &middot; Nota Control Panel</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="">
    <!-- Le styles -->
