...
4) Open the website in the browser and access it as: http://my_domain/php_code_folder_name/index.php 
   ...
   The php_code_folder_name is the name of the folder under which the downloaded code resides ('BillMeLater' folder in case you have not changed the default name).
