<?php 
	...
	*/
	...
	} else if(isset($_SESSION['TOKEN'])) //Raj modified code
	{
		...
		*/
		...
		if( $ackGetExpressCheckout == "SUCCESS" || $ackGetExpressCheckout == "SUCESSWITHWARNING") 
		{
			...
			*/
			...
			$shippingAmt        = $resArrayGetExpressCheckout["PAYMENTREQUEST_0_SHIPPINGAMT"]; // 'Shipping amount being used 
			/*
	...
	if(isset($_POST['shipping_method'])){
		if($_POST['shipping_method'] == "ups_XPD")
			$new_shipping = "8.00";
		else
		if($_POST['shipping_method'] == "ups_WXS")
			$new_shipping = "5.00";
		else
		if($_POST['shipping_method'] == "flatrate_flatrate")
			...
			if(isset($_SESSION['shippingAmt']))
			{
				...
				$finalPaymentAmount = $totalAmt + $new_shipping;
