...
function optionsframework_fields() {
	...
	foreach ( $options as $value ) {
		...
		case 'twitter_notification':
			$output .= '<div class="custom_notification">To use the Twitter Widget and the Social Counter you need to go to <a href="https://apps.twitter.com/" target="_blank">create a new app on Twitter</a>, name it whatever you want and follow the instrcutions. When your done open up the <strong>API Keys tab</strong> and push <strong>Create my access token</strong>. Wait a few seconds for it to finish and then refresh the page. <br><br>Now just fill in the inputs here below with the new information (make sure there aren\'t any unwanted spaces)</div>';
			break;
