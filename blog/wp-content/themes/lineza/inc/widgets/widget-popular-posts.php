...
class bpxl_popular_widget extends WP_Widget {
	...
	function bpxl_popular_widget() {
		...
		$this->WP_Widget( 'popular_widget', __('Lineza Popular Posts', 'bloompixel'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		<ul class="popular-posts">
			<?php
				$popularposts = new WP_Query('showposts='.$posts.'&orderby=comment_count');
			?>
